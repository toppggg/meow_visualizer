...
job_path_name = "/mnt/c/Users/Asger/Documents/Datalogi/Bachelor/meow_visualizer/visualizer/test_visualizer/test_performance/test_meow_integration/job.yml"
count = 100000
runs = 10
...
print("putting", count * runs ,"jobs in queue took: ", total_work_time, " seconds")
print("Average time to put one job in queue from meow: ", total_work_time / (count * runs), " seconds")
print("Average time to put one job in queue from meow: ", (total_work_time / (count * runs) * 1000000) , " microseconds")
# microseconds are 1.000.000'th of a second
print("Timing how long 1.000.000 jobs take to flush from queue")
